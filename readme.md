...
Quand cela est nécessaire, le fichier HTML est fourni.  Pour la sécurité de votre code, à chaque formulaire verifiez que ce qui est saisi correspond à ce qui est attendu.
...
Demander à l’utilisateur deux nombres. Ne garder que la partie entière du premier et convertir le deuxième en float. Les multiplier et afficher le résultat dans une boîte de dialogue.
